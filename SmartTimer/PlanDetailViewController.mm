...
//    return self.taskTableView != tableView ? [super numberOfSectionsInTableView:tableView] : 1;
//}
//
//- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
//{
//    // Return the number of rows in the section.
//    return self.taskTableView != tableView ? [super tableView:tableView numberOfRowsInSection:section] : [editPlan.tasks count];
//}
//
...
//    // NSString *CellIdentifier=[NSString stringWithFormat:@"TaskCell%d",indexPath.section];
//    
//    if(self.taskTableView == tableView){
...
//        }
//        if(cell) {
////            cell.textLabel.text = [currentTask getNameStr];
////            cell.detailTextLabel.text = [currentTask getStartTimeStr];
